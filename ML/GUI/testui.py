...
class Ui_MainWindow(object):
    ...
    def infoSet100(self):
        ...
        result = conn.execute(sqlquery)
        for row_num, row_data in enumerate(result):
            self.tableWidget_infoset100.setItem(row_num, 0, QtWidgets.QTableWidgetItem(str(row_data)))
    ...
    def setupUi(self, MainWindow):
        ...
        self.tableWidget_infoset100.setGeometry(QtCore.QRect(120, 280, 421, 251))
        self.tableWidget_infoset100.setObjectName("tableWidget_infoset100")
        self.tableWidget_infoset100.setColumnCount(0)
